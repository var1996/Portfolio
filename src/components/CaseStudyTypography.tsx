...
export default function CaseStudyTypography() {
  return (
    <div className="bg-black px-[30px] grid grid-cols-[1fr_2fr] gap-x-16 gap-y-12 pt-12 pb-12 mt-[10px]">
      ...
      {/* Col 2 */}
      <div className="flex flex-col gap-8 self-start mt-[45px]">
        ...
        {/* ── Specimen card ── */}
        <div style={{ border: '28px solid #D9B92C', padding: '44px 44px', borderRadius: '16px' }} className="bg-black overflow-hidden">
