...
export default function CaseStudyContext() {
  return (
    <div className="bg-black grid grid-cols-12 gap-6 pt-20 pb-24">
      ...
      {/* ── SECTION 1: Context ── */}
      <div className="col-start-2 col-span-7 flex flex-col gap-4">
        ...
        <div className="mt-2 flex flex-col gap-6 font-body text-[18px] font-normal leading-[1.5] text-white">
          <p>
      ...
      <div className="col-start-2 col-span-7 flex flex-col gap-4 mt-24">
        ...
        <p className="mt-2 font-body text-[18px] font-normal leading-[1.5] text-white">
